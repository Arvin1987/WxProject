...
namespace GuardWebAPI.WeChat.Controllers
{
    ...
    public class ActivityController : Controller
    {
        ...
        public FileStreamResult GetWxCode(string scene, string page = "pages/index/index")
        {
